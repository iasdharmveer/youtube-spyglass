...
>(({ className, ...props }, ref) => (
    <thead ref={ref} className={cn("bg-slate-800/80 [&_tr]:border-b [&_tr]:border-slate-700", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            "border-b border-slate-700/50 transition-colors hover:bg-slate-700/30 data-[state=selected]:bg-violet-600/10",
            className
        )}
        {...props}
    />
